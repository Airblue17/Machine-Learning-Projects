...
adult <- read.csv('R/Machine Learning Projects/R/Income Prediction - Logistic Regression/adult_sal.csv')
...
adult[adult=='?'] = NA
path = 'R/Machine Learning Projects/R/Income Prediction - Logistic Regression/plots/'

jpeg(paste(path, "Missing_Map.jpg", sep = ""))
...
ggsave(paste(path, "hist_age.jpg", sep = ""), plot = last_plot(), dpi = 300)
...
ggsave(paste(path, "hist_hrs.jpg", sep = ""), plot = last_plot(), dpi = 300)
...
ggsave(paste(path, "bar_region.jpg", sep = ""), plot = last_plot(), dpi = 300)
