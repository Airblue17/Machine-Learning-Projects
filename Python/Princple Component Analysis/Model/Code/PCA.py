...
plt.title("eigenvalues vs number of features")
plt.savefig("../Figures/eigenvalue.png")
##################################################
...
ax.axis("off")
plt.title("Mean Image of Train Dataset")
plt.savefig("../Figures/meandataset.png")
...
plt.savefig("../Figures/meandigit.png")
##################################################
...
for i in range(5):
    ...
    plt.title(title)
plt.savefig("../Figures/topeigenvector.png")  
##################################################
...
plt.savefig("../Figures/projComponents.png", bbox_inches='tight')  
##################################################
